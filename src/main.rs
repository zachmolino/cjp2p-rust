...
#[cfg(test)]
mod tree_v2_check_tests {
    use super::*;

    #[test]
    fn forged_trees_fail() {
        let tree = |data: &[u8]| {
            let n = (data.len() + BLOCK_SIZE!() - 1) / BLOCK_SIZE!();
